...
2. **Connect to Kafka:**  
    - Start JConsole.
    - Enter the Kafka broker’s JMX port (usually `9999`) and hostname.
...
**Tip:** Make sure the Kafka broker is started with JMX enabled (check the `KAFKA_JMX_OPTS` environment variable).
